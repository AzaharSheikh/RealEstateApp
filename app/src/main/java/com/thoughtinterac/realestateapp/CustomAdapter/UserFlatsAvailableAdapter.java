 ...
 */
public class UserFlatsAvailableAdapter extends BaseAdapter {
    private Activity activity;
    private LayoutInflater inflater;
    private List<SoldFlatsModel> flatListItems;
    public UserFlatsAvailableAdapter(Activity activity , List<SoldFlatsModel> flatListItems) {
...
//        TextView txt_view_author_name1 = (TextView) convertView.findViewById(R.id.txt_view_author_name1);
        ...
        ImageView img_pencile=(ImageView)convertView.findViewById(R.id.img_pencile);
        img_pencile.setVisibility(View.INVISIBLE);
