...
import com.thoughtinterac.realestateapp.Activities.CommonPageSingleProjectActivity;
 ...
 */
public class CommonPageProjectListAdapter extends BaseAdapter {

    private Activity activity;
    private LayoutInflater inflater;
    private List<RealtorProjectListModel> projectListItems;
    public CommonPageProjectListAdapter(Activity activity, List<RealtorProjectListModel> projectListItems) {
