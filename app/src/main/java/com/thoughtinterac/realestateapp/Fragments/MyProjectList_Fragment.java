 ...
 */
public class MyProjectList_Fragment extends Fragment {
    ...
    public static MyProjectList_Fragment newInstance(String param1, String param2) {
        MyProjectList_Fragment fragment = new MyProjectList_Fragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        List<MyProjectListModel> docListMain = new ArrayList<MyProjectListModel>();
...
//            list.setDoc_name(project_list.get(i).toString());
//            list.setDoc_status(project_img.get(i).toString());
//            list.setDoc_deatils(projDetails.get(i).toString());
//            docListMain.add(list);
        }
        ListView listView = (ListView) rootView.findViewById(R.id.my_project);
        listView.setDivider(null);
        ViewGroup header = (ViewGroup)inflater.inflate(R.layout.user_myproject_list, listView, false);
//        adapter= new MyProjectListAdapter(getActivity(),docListMain);
